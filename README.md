...
5. **Follow Setup Instructions:** A window will guide you through the installation. Follow the prompts carefully to complete the setup.

6. **Launch the IDE:** After installation, you can find the SNU 2D Programming Tools IDE in your applications. Open it to start coding.
...
1. **Open Settings:** Go to the ‘File’ menu, then select ‘Preferences’.
2. **Change Preferences:** Modify settings such as font size, themes, and code formatting to your liking.
3. **Save Changes:** Click the ‘Save’ button to apply your preferences.
